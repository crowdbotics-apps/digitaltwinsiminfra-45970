"""
Django settings for digitaltwinsiminfra_45970 project.
...
ROOT_URLCONF = 'digitaltwinsiminfra_45970.urls'
...
WSGI_APPLICATION = 'digitaltwinsiminfra_45970.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "digitaltwinsiminfra_45970 API",
    "DESCRIPTION": "API documentation for digitaltwinsiminfra_45970 App",
    "VERSION": "v1",
}
